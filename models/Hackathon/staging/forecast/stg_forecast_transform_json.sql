SELECT
  ...
  TIMESTAMP_SECONDS(CAST(JSON_VALUE(raw_data, '$.city.sunrise') AS INT64)) AS lever_soleil,
  TIMESTAMP_SECONDS(CAST(JSON_VALUE(raw_data, '$.city.sunset') AS INT64)) AS coucher_soleil,
